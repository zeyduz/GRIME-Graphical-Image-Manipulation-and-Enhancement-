...
public class RedComponentTest {
  ...
  @Test
  public void testExample1Red() {
    setupRed();
    // Create and Execute the Command
    ImageCommand cmd = new RedComponent("example1", "example1-red");
    cmd.execute(model);
    ...
    // Actual
    Image red = model.getImageCopy("example1-red");
    ...
    assertEquals(expected_image, red);
  }

  @Test
  public void testExample2Red() {
    setupRed();
    // Create and Execute the Command
    ImageCommand cmd = new RedComponent("example2", "example2-red");
    cmd.execute(model);
    ...
    // Actual
    Image red = model.getImageCopy("example2-red");
