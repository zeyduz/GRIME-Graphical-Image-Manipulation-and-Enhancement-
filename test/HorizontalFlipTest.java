...
public class HorizontalFlipTest {
  ...
  @Test
  public void testExample1Horizontal() {
    setupHorizontal();
    // Create and Execute the Command
    ImageCommand cmd = new FlipHorizontal("example1", "example1-new");
    cmd.execute(model);
    ...
    // Actual
    Image horizontal = model.getImageCopy("example1-new");
    ...
    assertEquals(expected_image, horizontal);
  }

  @Test
  public void testExample2Horizontal() {
    setupHorizontal();
    // Create and Execute the Command
    ImageCommand cmd = new FlipHorizontal("example2", "example2-new");
    cmd.execute(model);
    ...
    // Actual
    Image horizontal = model.getImageCopy("example2-new");

    // Expected
    Pixel[][] expected = new RGBAPixel[3][2];
    expected[0][1] = new RGBAPixel(255, 255, 255, 255, 255);
    expected[0][0] = new RGBAPixel(255, 0, 255, 0, 255);
    expected[1][1] = new RGBAPixel(255, 100, 100, 100, 255);
    expected[1][0] = new RGBAPixel(255, 0, 255, 255, 255);
    expected[2][1] = new RGBAPixel(255, 255, 0, 255, 255);
    expected[2][0] = new RGBAPixel(255, 0, 0, 100, 255);
